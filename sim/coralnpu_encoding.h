...
#ifndef SIM_CORALNPU_ENCODING_H_
#define SIM_CORALNPU_ENCODING_H_
...
class CoralNPUEncoding : public CoralNPUEncodingBase {
 public:
  explicit CoralNPUEncoding(CoralNPUState* state);
  ~CoralNPUEncoding() override;
 ...
 protected:
  ...
  CoralNPUState* state() const { return state_; }
...
#endif  // SIM_CORALNPU_ENCODING_H_
