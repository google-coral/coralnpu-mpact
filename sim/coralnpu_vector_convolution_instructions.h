...
#ifndef SIM_CORALNPU_VECTOR_CONVOLUTION_INSTRUCTIONS_H_
#define SIM_CORALNPU_VECTOR_CONVOLUTION_INSTRUCTIONS_H_
...
typedef struct CoralNPUVConvCmd {
...
typedef struct CoralNPUVDwconvCmd {
  uint32_t mode : 2;      // 1:0
...
void CoralNPUVConv(Instruction* inst);

void CoralNPUVDwconv(bool write_acc, Instruction* inst);

}  // namespace coralnpu::sim

#endif  // SIM_CORALNPU_VECTOR_CONVOLUTION_INSTRUCTIONS_H_
