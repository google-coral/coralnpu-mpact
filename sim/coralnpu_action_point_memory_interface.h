...
#ifndef SIM_CORALNPU_ACTION_POINT_MEMORY_INTERFACE_H_
#define SIM_CORALNPU_ACTION_POINT_MEMORY_INTERFACE_H_
...
// This file defines the CoralNPUActionPointMemoryInterface class which provides
...
// the CoralNPU ebreak instruction to stop execution.

class CoralNPUActionPointMemoryInterface : public ActionPointMemoryInterface {
 public:
  ...
  CoralNPUActionPointMemoryInterface(MemoryInterface* memory,
                                     InvalidateFcn invalidate_fcn);
  ~CoralNPUActionPointMemoryInterface() override;
...
#endif  // SIM_CORALNPU_ACTION_POINT_MEMORY_INTERFACE_H_
