...
CoralNPUActionPointMemoryInterface::CoralNPUActionPointMemoryInterface(
...
absl::Status CoralNPUActionPointMemoryInterface::WriteOriginalInstruction(
    uint64_t address) {
...
absl::Status CoralNPUActionPointMemoryInterface::WriteBreakpointInstruction(
    uint64_t address) {
  auto it = instruction_map_.find(address);
  if (it == instruction_map_.end()) {
...
int CoralNPUActionPointMemoryInterface::GetInstructionSize(
