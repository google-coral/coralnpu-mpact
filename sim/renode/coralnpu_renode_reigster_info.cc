...
CoralNPURenodeRegisterInfo* CoralNPURenodeRegisterInfo::instance_ = nullptr;

void CoralNPURenodeRegisterInfo::InitializeRenodeRegisterInfo() {
...
CoralNPURenodeRegisterInfo::CoralNPURenodeRegisterInfo() {
  InitializeRenodeRegisterInfo();
}

const CoralNPURenodeRegisterInfo::RenodeRegisterInfo&
CoralNPURenodeRegisterInfo::GetRenodeRegisterInfo() {
  return Instance()->GetRenodeRegisterInfoPrivate();
}

CoralNPURenodeRegisterInfo* CoralNPURenodeRegisterInfo::Instance() {
  if (instance_ == nullptr) {
    instance_ = new CoralNPURenodeRegisterInfo();
  }
  return instance_;
}

const CoralNPURenodeRegisterInfo::RenodeRegisterInfo&
CoralNPURenodeRegisterInfo::GetRenodeRegisterInfoPrivate() {
