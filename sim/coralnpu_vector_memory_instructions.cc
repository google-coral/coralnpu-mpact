...
template void CoralNPUVLd<int8_t>(bool, bool, bool, Instruction*);
template void CoralNPUVLd<int16_t>(bool, bool, bool, Instruction*);
template void CoralNPUVLd<int32_t>(bool, bool, bool, Instruction*);
...
template void CoralNPUVLdRegWrite<int8_t>(bool, Instruction*);
template void CoralNPUVLdRegWrite<int16_t>(bool, Instruction*);
template void CoralNPUVLdRegWrite<int32_t>(bool, Instruction*);
...
template void CoralNPUVSt<int8_t>(bool, bool, bool, Instruction*);
template void CoralNPUVSt<int16_t>(bool, bool, bool, Instruction*);
template void CoralNPUVSt<int32_t>(bool, bool, bool, Instruction*);
...
template void CoralNPUVDup<int8_t>(bool, Instruction*);
template void CoralNPUVDup<int16_t>(bool, Instruction*);
template void CoralNPUVDup<int32_t>(bool, Instruction*);
...
template void CoralNPUVStQ<int8_t>(bool, Instruction*);
template void CoralNPUVStQ<int16_t>(bool, Instruction*);
template void CoralNPUVStQ<int32_t>(bool, Instruction*);
...
template void CoralNPUGetVl<int8_t>(bool, bool, bool, const Instruction*);
template void CoralNPUGetVl<int16_t>(bool, bool, bool, const Instruction*);
template void CoralNPUGetVl<int32_t>(bool, bool, bool, const Instruction*);
